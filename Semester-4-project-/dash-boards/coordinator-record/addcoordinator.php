...
if (isset($_POST['submit_coordinator'])) {
    ...
    if (empty($firstname) || empty($email) || empty($password)) {
        ...
        $insert_query = "INSERT INTO staff (FirstName, LastName, Email, Password, PhoneNo, CNIC, UserRole, Designation, Department, joiningDate, Qualification, Salary, Status) 
                         VALUES ('$firstname', '$lastname', '$email', '$hashed_password', '$phoneNo', '$cnic', '$role', '$designation', '$department', '$joiningDate', '$qualification', '$salary', '$status')";
        ...
        <div class="row justify-content-center">
            <div class="col-md-10">
                <div class="card shadow-sm border-0 p-4">
                    <h2 class="text-center mb-4">Add Coordinator</h2>
                    
                    <?php echo $message; ?>
                   <div class="row">
                    <div class="col-md-4">
                         <a href="coordinator-record.php" class="btn btn-primary">Back</a>
                    </div>
                   </div>
                    <form action="" method="POST">
                        ...
                        <div class="row">
                            <div class="col-md-6 form-group">
                                ...
                                <input type="text" name="phoneNo" class="form-control" placeholder="0300-0000000">
                            </div>
                            <div class="col-md-6 form-group">
                        ...
                        <button type="submit" name="submit_coordinator" class="btn btn-primary btn-block mt-3">Register Coordinator</button>
                    </form>
                </div>
            </div>
        </div>
