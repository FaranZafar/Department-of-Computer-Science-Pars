...
if (isset($_POST['submit_Teacher'])) {
    ...
    $employmenttype = mysqli_real_escape_string($con, $_POST['visiting']);
    ...
    if (empty($firstname) || empty($email) || empty($password)) {
        ...
        // 3. Insert Query (Fixed the $employmenttype variable and spacing)
        $insert_query = "INSERT INTO staff (FirstName, LastName, Email, Password, PhoneNo, CNIC, UserRole, Designation, Department, joiningDate, Qualification, Salary, Status, EmploymentType) 
                         VALUES ('$firstname', '$lastname', '$email', '$password', '$phoneNo', '$cnic', '$role', '$designation', '$department', '$joiningDate', '$qualification', '$salary', '$status', '$employmenttype')";
...
<head>
    ...
    <title>Add Teacher | Pars Campus</title>
            ...
            <div class="col-md-10">
                <div class="card shadow-sm border-0 p-4">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        ...
                        <a href="visitingteacher-record.php" class="btn btn-outline-secondary">Back to Records</a>
                    </div>
                    ...
                    <form action="" method="POST">
                        ...
                        <button type="submit" name="submit_Teacher" class="btn btn-primary btn-block mt-3 shadow-sm">Register Teacher</button>
                    </form>
                </div>
            </div>
        </div>
