...
$query = "SELECT StaffID, FirstName, LastName, Department,Qualification ,joiningDate FROM staff WHERE UserRole='Teacher' AND EmploymentType='Permanent'";
            ...
            <div class="card bg-white p-4">
                <form action="" method="POST">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <div>
                            <h3 class="font-weight-bold text-gray-800">Staff Attendance</h3>
                                    ...
                                    <?php while($row = $result->fetch_assoc()): ?>
                                        <tr>
                                            ...
                                            <td class="d-flex justify-content-center">
                                              ...
                                              <a href="view_attendance.php?id=<?php echo $row['StaffID']; ?>" class="btn btn-sm btn-info mr-1 shadow-sm">View Attendance</a>
                                              <a href="update.php?id=<?php echo $row['StaffID']; ?>" class="btn btn-sm btn-success mr-1">Update</a>
                                              <a href="delete.php?id=<?php echo $row['StaffID']; ?>" class="btn btn-sm btn-danger">Delete</a>
                                            </td>
                                        </tr>
                                    <?php endwhile; ?>
                                <?php else: ?>
