...
if (isset($_POST['update_teacher'])) {
    ...
    $employment  = mysqli_real_escape_string($con, $_POST['visiting']); // Added this
    ...
    if ($con->query($update_sql)) {
        echo "<script>window.location.href='visitingteacher-record.php?msg=updated';</script>";
        exit();
    } else {
                    ...
                    <form action="" method="POST">
                        ...
                        <div class="row">
                            <div class="col-md-6 form-group">
                                ...
                                <select name="role" class="form-control">
                                    <option value="Teacher" <?php echo ($data['UserRole'] == 'Teacher') ? 'selected' : ''; ?>>Teacher</option>
                                    <option value="Coordinator" <?php echo ($data['UserRole'] == 'Coordinator') ? 'selected' : ''; ?>>Coordinator</option>
                                    <option value="Admin" <?php echo ($data['UserRole'] == 'Admin') ? 'selected' : ''; ?>>Admin</option>
                                </select>
                            </div>
                            <div class="col-md-6 form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 form-group">
                                ...
                                <input type="text" name="visiting" class="form-control" 
                                       value="<?php echo htmlspecialchars($data['EmploymentType']); ?>">
                            </div>
                        </div>

                        <div class="mt-4">
                            <button type="submit" name="update_teacher" class="btn btn-success btn-lg btn-block shadow-sm">Update Staff Member</button>
                            <a href="visitingteacher-record.php" class="btn btn-link btn-block text-muted">Cancel and Go Back</a>
                        </div>
                    </form>
                </div>
            </div>
