        ...
        <div class="row justify-content-center">
            <div class="col-md-10">
                <div class="card shadow-sm border-0 p-4">
                   ...
                   <div class="row">
                    <div class="col-md-4">
                         <a href="pteacher-record.php" class="btn btn-primary">Back</a>
                    </div>
                   </div>
                    <form action="" method="POST">
                        ...
                        <button type="submit" name="submit_Teacher" class="btn btn-primary btn-block mt-3">Register Teacher</button>
                    </form>
                </div>
            </div>
        </div>
